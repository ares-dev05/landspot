...
export default class Viewer {
  ...
  animate() {
    ...
    this.lightIntensity();
    // if (this.intersec) {
    //   this.intersec.object.material.roughness = this.guiData.roughness;
    //   this.intersec.object.material.metalness = this.guiData.metalness;
    //   this.intersec.object.material.color.setHex(this.guiData.color);
    //   this.intersec.object.material.emissive.setHex(this.guiData.emissive);
    // }
