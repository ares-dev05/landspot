...
class Pan extends Component {
    ...
    componentWillUnmount() {
        removeEvent(parent, 'mousedown', this.onStart);
        removeEvent(parent, 'touchstart', this.onStart);
        removeEvent(parent, 'mouseup', this.onEnd);
        removeEvent(parent, 'touchend', this.onEnd);
        removeEvent(parent, 'mouseout', this.onEnd);
