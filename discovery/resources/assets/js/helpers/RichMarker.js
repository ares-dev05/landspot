...
if(window.google) {
    RichMarker.prototype.__proto__ = new window.google.maps.OverlayView();
} else {
    if (process.env.NODE_ENV !== 'production') {
        console.warn('Google not loaded', window.location.href);
    }
}
 ...
 * @enum {number}
 */
export const RichMarkerPosition = Object.freeze({
    'TOP_LEFT': 1,
    'TOP': 2,
    'TOP_RIGHT': 3,
    'LEFT': 4,
