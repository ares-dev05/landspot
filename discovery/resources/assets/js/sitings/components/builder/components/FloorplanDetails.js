...
import {CssStatuses, Floorplans, HISTORY_EXISTS_UNREAD} from './Floorplans';
import * as FormItem from './items';
import _ from 'lodash';
import classnames from 'classnames';

class FloorplanDetails extends Component {
    ...
    static propTypes = {
        ...
        resetFloorplanFormStore: PropTypes.func.isRequired,
    ...
    componentDidMount() {
        const {getFloorplanData, match: {params: {floorplanId}}} = this.props;
        if (floorplanId) {
    ...
    static getDerivedStateFromProps(props, state) {
        ...
        const {FLOORPLAN_DATA_UPDATED} = props.builderNewFloorplanForm;
    ...
    backToResults = () => {
        this.props.history.push(Floorplans.componentUrl + this.state.backParams);
    };
    ...
    render() {
        const {ranges, states, floorplanData} = this.props.builderNewFloorplanForm;
