                    ...
                    <div className="filter-bar">
                        <div className="filter-form">
                            ...
                            <div className="first-row has-nav">
                                <span className="filters-header">Upload a reference plan</span>
                            </div>

                            <div className="step-note">
                                <p>
                                    Upload an area plan in PDF format. This document will be displayed
                                    as a reference during the process of creating your siting.
                                </p>

                                {plan && (
                                    <div className='doc-name'>
                                        <a href={plan.viewURL} target='_blank'
                            ...
                            <React.Fragment>
                                <div className="form-rows form-upload">
                                    <div className="form-row form-upload-container">
                                        <span className="label form-upload-label">PLAN OF SUBDIVISION</span>
                                        <FileUploader
                                            className='form-row'
                                            ...
                                            chooseFileButton={
                                                uploadingReferenceFile
                                                    ...
                                                    : <button type='button'
                                                              className={`button primary form-upload-button ${uploadingEngineeringFile ? 'disabled' : ''}`}>
                                                        <i className="landconnect-icon cloud-upload"/>
                                                        Upload a Plan of Sub
                                                    </button>
                                            }
