...
@section('content')
    <div class="page" style="background: #fff url('{{$sitingImage}}') center center/cover no-repeat;">
        ...
        <div class="footer">
            ...
            <div class="note">
                This is a preliminary siting and is subject to a clear copy of title and approval of the builder.<br/>
                This siting is subject to change due to developer approval, state building regulations and council requirements where applicable.
            </div>
        </div>
    </div>
@endsection
