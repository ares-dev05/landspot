...
@section('styles')
    <style type="text/css">
        ...
        .page .header::before {
            ...
            height: 100%;
            width: 40mm;
            background: {{$company->companyThemeColor ?? '#fff'}} url("{{$company->company_expanded_logo}}") 5mm center/31mm no-repeat;
        }
...
@section('content')
    <div class="page" style="background: #fff url('{{$sitingImage}}') center center/cover no-repeat;">
        ...
        <div class="footer">
            ...
            <div class="note">
                Note: this is a preliminary siting and is subject to clear copy of the title and the approval
                of Sherridon Homes.
                <br>
                This siting may be subject to a developer approval process.
                <br>
