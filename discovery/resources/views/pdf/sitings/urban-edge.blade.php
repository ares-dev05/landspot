...
@section('styles')
    <style type="text/css">
        ...
        .page .header::before {
            ...
            height: 100%;
            width: 40mm;
            background: #fff url("{{$company->company_expanded_logo}}") 5mm center/30mm no-repeat;
        }
...
@section('content')
    <div class="page" style="background: #fff url('{{$sitingImage}}') center center/cover no-repeat;">
        ...
        <div class="footer">
            ...
            <div class="note">
				House siting is indicative only. Official siting will be provided at contract presentation, following soil test and survey with consideration given to rescode,<br/>
				site fall, retaining walls, covenant on title and estate guidelines. Siting maybe adjusted to comply with any/all of the above considerations.
            </div>
        </div>
    </div>
@endsection
