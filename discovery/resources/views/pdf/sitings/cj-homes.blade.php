...
@section('content')
    <div class="page" style="background: #fff url('{{$sitingImage}}') center center/cover no-repeat;">
        ...
        <div class="footer">
            ...
            <div class="note">
                This is a preliminary siting only and is subject to a copy of the property title and final approval by the builder.<br/>
                This siting is subject to developer approval and all local, state and federal building regulations.
            </div>
        </div>
    </div>
@endsection
