...
@section('styles')
    <style type="text/css">
        ...
        .page .header {
            height: 24mm;
            background: #eee url("{{$company->company_expanded_logo}}") 5mm center/31mm no-repeat;
        }
...
@section('content')
    <div class="page" style="background: #fff url('{{$sitingImage}}') center center/cover no-repeat;">
        <div class="header">
            @include('pdf.sitings.blocks.client-details-dual')
        ...
        <div class="footer">
            @include('pdf.sitings.blocks.site-coverage-dual')
            <div class="note">
