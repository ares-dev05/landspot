...
@section('styles')
    <style type="text/css">
        ...
        .page .header::before {
            ...
            height: 100%;
            width: 40mm;
            @if(isset($areaData->logoRange))
                background: #fff url("{{'https://landconnect.s3-ap-southeast-2.amazonaws.com/'.$areaData->logoRange}}") 5mm center/30mm no-repeat;
            @else
        ...
        <div class="footer">
            ...
            <div class="note">
                <span class="important">
                    NOTE: Siting is preliminary only and subject to final site levels and conditions
                    along with all government
                    <br>
                    and developer codes, regulations and requirements. To be used as a guide only.
                </span>
            </div>
        </div>
    </div>
